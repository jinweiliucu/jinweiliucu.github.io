...
Short Bio
======
Dr. Jinwei Liu is an Associate Professor with the Department of Computer and Information Sciences at Florida A&M University (FAMU). He was recognized for outstanding achievement in academic publications. He was awarded a 2021-2022 FRAP (Faculty Research Awards Program) grant at FAMU. He was the recipient of the 2022-2023 Emerging Research in STEM Award at FAMU. He has received awards from NSF (1 as PI and 1 as Co-PI), Cyber Florida, etc. (approximately $2.6 Million in total). His research interests include cloud computing/storage, AI/ML, health care, network science, big data, cybersecurity, etc. His work has led to a number of top journal/conference publications (e.g., IEEE/ACM TON, IEEE TMC, IEEE TPDS, NPJ Digital Medicine, IEEE TC, IEEE TSC, etc.). He has regularly served as a program chair, committee member, publicity chair, and session chair for a number of international conferences and workshops, such as AAAI, IEEE/ACM CCGRID, ACM/IEEE IoTDI, IEEE ICC, IEEE GLOBECOM, IEEE ICCCN, IEEE BigComp, PDCAT, IEEE WF-PST, IEEE ICFEC, IEEE CSCWD, ICDCIT, IEEE ICCCBDA, etc. He has served as an Editor-in-Chief and Associate Editor for several journals. He has served on multiple U.S. NSF review panels and regularly review for leading journals and conferences (e.g., IEEE TMC, IEEE TPDS, IEEE TKDE, IEEE TSC, IEEE TVT, ACM CSUR, JPDC, ESWA, ACM TWEB, ACM TMIS, AAAI, etc.). He is a member of the IEEE, the ACM, the AAAI, and the DT4HS (Digital Twins for Health Society).
